...
def main():
    ...
    prediction = [object1.StartTraining(x0InitilizationVal, np.array([xValDummy[0] for xValDummy in Cont1]), np.array([xValDummy[1] for xValDummy in Cont1])) for x0InitilizationVal in np.array([xValDummy[0] for xValDummy in Cont2])]
    CalmseError = ((prediction - np.array([xValDummy[1] for xValDummy in Cont2]))**2).mean()
    object1.displayPrintContentInfo(np.array([xValDummy[0] for xValDummy in Cont1]), np.array([xValDummy[1] for xValDummy in Cont2]), CalmseError)
